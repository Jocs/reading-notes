...
#system('/Applications/Google\ Chrome.app/Contents/MacOS/Google\ Chrome') # 代开 chrome 浏览器
print sep
print pathsep
print linesep
print urandom(8)
import webbrowser
#webbrowser.open('/Applications/Google\ Chrome.app/Contents/MacOS/Google\ Chrome')
